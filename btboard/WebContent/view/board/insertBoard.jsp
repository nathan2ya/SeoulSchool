...
<form name="insertBoardForm" action="/btboard/insertBoard.do" method="post" onSubmit="return checkIt()">
	<table border="1" align="center" width="800" bordercolor="#E7E7E7">
		...
		<tr>
			...
			<td width="550" height="8" colspan="3">
				<input type="text" name="board_subject" id="board_subject" size="70" maxlength="100" onKeyDown="sub_check_byte(this.form);" onkeyup="sub_check_byte(this.form);"/>
		...
		<tr>
	 	...
	 	<tr>
	 		<td width="750" colspan="4" align="right">
	 			<input name="submit" type="submit"  value="글 쓰기"/>
